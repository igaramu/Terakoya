...
さっそく、`about-us.html`ファイルの`body`部分に自己紹介文を記載し、マークアップをしていきましょう！

![img_15.png](img/img_15.png)

> ポイント！
>
> VSコードではHTMLファイルをプレビューする機能があります。
>
> エディター画面の上部右側にあ員痕があります。
>
> そこをクリックすると…
>
> ![](img/img_16.png)
>
> ↓こんな感じになります。いちいちブラウザで確認する手間が省けます。
>
> （`<br>`が無いので、改行されてないですね！）
>
...
「見出し」とは、記事の内容が一見して分かるように、文章の前に示す言葉、標題です。

`<h1></h1>`で表し、１～６まで重要度の高さで表していきます。
...
先程の自己紹介文に見出しを付けていきましょう。

##### h1

`h1`は１記事に何個あっても良いですが、記事のタイトルに付けるのが無難です。
